/*
 * @(#)rti_dl_xml_c.h    generated by: makeheader    Sat Nov 23 02:41:03 2013
 *
...
/** 
 * @internal
 * @defgroup RTI_DL_XMLConfig RTI_DL_XMLConfig
 *
 * This API can be used for internal development when integrating RTI Distributed 
 * Logger in the XML configuration of their application or service.
*/
/* ------------------------------------------------------------ */
