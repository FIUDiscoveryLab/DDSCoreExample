...
/*
 * @(#)pres_cstReaderCollator.h    generated by: makeheader    Sat Nov 23 02:38:53 2013
 *
...
#define PRES_CST_READER_COLLATOR_REPLACE_EMPTY_INSTANCES "dds.data_reader.queue.replace_not_alive_empty_instances"
...
struct PRESCstReaderCollatorProperty {
    ...
    */
    ...
    /* Indicates if replacement of empty instances is allowed */
    RTIBool replaceNotAliveEmptyInstances;
  ...
  #define PRES_CST_READER_COLLATOR_PROPERTY_DEFAULT {      \
    ...
    1, /* samplesPerAppAck */ \
    RTI_FALSE, /* replaceNotAliveEmptyInstances */ \
...
PRESCstReaderCollator_createIndexCondition(struct PRESCstReaderCollator * self,
...
extern PRESDllExport 
RTIBool
PRESCstReaderCollator_deleteIndexCondition(struct PRESCstReaderCollator * self,
                                           struct PRESPsReader *owner,
                                           struct PRESCondition * presCondition);

extern PRESDllExport 
RTIBool
PRESCstReaderCollator_createIndex(struct PRESCstReaderCollator * self,
...
extern PRESDllExport 
RTIBool
PRESCstReaderCollator_deleteIndex(struct PRESCstReaderCollator * self,
                                  const char * index_name);
