...
/*
 * @(#)dds_cpp_subscription.h    generated by: makeheader    Sat Nov 23 02:40:01 2013
 *
...
class DDSCPPDllExport DDSDataReader : public DDSDomainEntity {
  ...
  public:
    ...
    virtual DDS_ReturnCode_t create_corelation_index(
        const char* index_name) {
        return _impl->create_corelation_index(index_name);
