...
/*
 * @(#)dds_cpp_domain.h    generated by: makeheader    Sat Nov 23 02:40:01 2013
 *
...
class DDSCPPDllExport DDSDomainParticipant : public DDSEntity {
  ...
  public:
    ...
    */
     ...
     */
    virtual DDS_ReturnCode_t register_durable_subscription(DDS_EndpointGroup_t& group,
                                                           const char *topic_name)
        = 0;

    /*e \dref_DomainParticipant_delete_durable_subscription
     */
    virtual DDS_ReturnCode_t delete_durable_subscription(DDS_EndpointGroup_t& group)
        = 0;
