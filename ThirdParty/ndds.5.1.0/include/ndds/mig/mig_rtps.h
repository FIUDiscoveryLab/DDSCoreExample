...
/*
 * @(#)mig_rtps.h    generated by: makeheader    Sat Nov 23 02:38:34 2013
 *
 *		built from:	rtps.ifc
 */
...
#define mig_rtps_h
  ...
  /* Inline param */
  #define MIG_RTPS_DATA_BATCH_SAMPLE_INFO_INLINE_PARAM_SIZE_MAX_WITHOUT_KEYHASH (68)
  #define MIG_RTPS_DATA_BATCH_SAMPLE_INFO_INLINE_PARAM_SIZE_MAX (88)
  #define MIG_RTPS_DATA_BATCH_SAMPLE_INFO_INLINE_PARAM_UNKEYED_SIZE_MAX (60)

  #define MIG_RTPS_DATA_BATCH_SAMPLE_INFO_SIZE_MAX (108)
