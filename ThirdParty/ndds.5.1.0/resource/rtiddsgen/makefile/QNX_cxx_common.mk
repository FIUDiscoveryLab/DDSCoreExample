...
EXTRA_LIBVPATH+=$(NDDSHOME)/lib/%%archName%%  \
	$(QNX_TARGET)/%%variant%%/lib
#===== LIBS - a space-separated list of library items to be included in the link.
LIBS+=-B%%libType%% %%carrot%%nddscpp%%libSuffix%% %%carrot%%nddsc%%libSuffix%% %%carrot%%nddscore%%libSuffix%% %%carrot%%socket
