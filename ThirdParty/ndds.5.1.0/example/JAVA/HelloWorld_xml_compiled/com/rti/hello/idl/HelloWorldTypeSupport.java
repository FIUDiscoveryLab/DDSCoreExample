...
public class HelloWorldTypeSupport extends TypeSupportImpl {
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.hello.idl.MAX_NAME_LEN.VALUE))) + 1);
            
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.hello.idl.MAX_MSG_LEN.VALUE))) + 1);
...
HelloWorld typedSrc = (HelloWorld) src;    
        ...
        dst.writeString(typedSrc.sender,((com.rti.hello.idl.MAX_NAME_LEN.VALUE)));
            
        dst.writeString(typedSrc.message,((com.rti.hello.idl.MAX_MSG_LEN.VALUE)));
...
HelloWorld typedDst = (HelloWorld) dst;
    ...
    try {
            ...
            typedDst.sender = src.readString(((com.rti.hello.idl.MAX_NAME_LEN.VALUE)));
            
            typedDst.message = src.readString(((com.rti.hello.idl.MAX_MSG_LEN.VALUE)));
...
HelloWorld typedDst = (HelloWorld) sample;
    ...
    protected HelloWorldTypeSupport() {
        ...
        super(TYPE_NAME, true,HelloWorldTypeCode.VALUE,HelloWorld.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
