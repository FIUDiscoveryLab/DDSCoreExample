...
public class ThroughputCommandKindTypeSupport extends TypeSupportImpl {    
     ...
     * So, for example:
     *    myEnumField = ThroughputCommandKindTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
...
ThroughputCommandKind typedSrc = (ThroughputCommandKind) src;   
    ...
    protected ThroughputCommandKindTypeSupport() {
            ...
            super(TYPE_NAME, false /*no key*/,null,ThroughputCommandKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
