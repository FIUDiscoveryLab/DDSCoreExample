 ...
 * PrimeNumberReply.
 */
public class PrimeNumberReplyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PrimeNumberReply";
    ...
    private static final PrimeNumberReplyTypeSupport _singleton
        = new PrimeNumberReplyTypeSupport();
     ...
     */
    public static PrimeNumberReplyTypeSupport get_instance() {
        return _singleton;
    }

    public static PrimeNumberReplyTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return PrimeNumberReply.create();
    }
     ...
     * <code>this</code> is not a <code>PrimeNumberReply</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        PrimeNumberReply typedDst = (PrimeNumberReply) destination;
        PrimeNumberReply typedSrc = (PrimeNumberReply) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, ((com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
            
        currentAlignment +=  com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        PrimeNumberReply typedSrc = (PrimeNumberReply) sample;
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceSerializedSize(currentAlignment, typedSrc.primes);
            
        currentAlignment += com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_size(
...
PrimeNumberReply typedSrc = (PrimeNumberReply) src;    
        ...
        dst.writeIntSeq(typedSrc.primes,((com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
            
        com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
PrimeNumberReply typedDst = (PrimeNumberReply) dst;
    ...
    try {
            ...
            src.readIntSequence(
                typedDst.primes,
                ((com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE)));
            
            typedDst.status = (com.rti.example.primes.idl.PrimeNumberCalculationStatus)com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);            
...
PrimeNumberReply typedDst = (PrimeNumberReply) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
PrimeNumberReply typedDst = (PrimeNumberReply) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new PrimeNumberReplyDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new PrimeNumberReplyDataReader(native_reader, listener, mask, this);                
    ...
    protected PrimeNumberReplyTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PrimeNumberReplyTypeCode.VALUE,PrimeNumberReply.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected PrimeNumberReplyTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,PrimeNumberReplyTypeCode.VALUE,PrimeNumberReply.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
