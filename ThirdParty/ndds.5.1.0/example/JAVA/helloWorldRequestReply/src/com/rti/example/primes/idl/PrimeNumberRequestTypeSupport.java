 ...
 * PrimeNumberRequest.
 */
public class PrimeNumberRequestTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PrimeNumberRequest";
    ...
    private static final PrimeNumberRequestTypeSupport _singleton
        = new PrimeNumberRequestTypeSupport();
     ...
     */
    public static PrimeNumberRequestTypeSupport get_instance() {
        return _singleton;
    }

    public static PrimeNumberRequestTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return PrimeNumberRequest.create();
    }
    ...
    public Class get_type() {
        return PrimeNumberRequest.class;
    }
     ...
     * <code>this</code> is not a <code>PrimeNumberRequest</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        PrimeNumberRequest typedDst = (PrimeNumberRequest) destination;
        PrimeNumberRequest typedSrc = (PrimeNumberRequest) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        PrimeNumberRequest typedSrc = (PrimeNumberRequest) sample;
...
PrimeNumberRequest typedSrc = (PrimeNumberRequest) src;    
        ...
        dst.writeInt(typedSrc.n);        
            
        dst.writeInt(typedSrc.primes_per_reply);        
...
PrimeNumberRequest typedDst = (PrimeNumberRequest) dst;
        
            typedDst.clear();
    try {

            typedDst.n = src.readInt();
            
            typedDst.primes_per_reply = src.readInt();
...
PrimeNumberRequest typedDst = (PrimeNumberRequest) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
PrimeNumberRequest typedDst = (PrimeNumberRequest) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new PrimeNumberRequestDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new PrimeNumberRequestDataReader(native_reader, listener, mask, this);                
    ...
    protected PrimeNumberRequestTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PrimeNumberRequestTypeCode.VALUE,PrimeNumberRequest.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected PrimeNumberRequestTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,PrimeNumberRequestTypeCode.VALUE,PrimeNumberRequest.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
