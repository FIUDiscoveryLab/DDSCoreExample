 ...
 */
public class PrimeNumberCalculationStatusTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PrimeNumberCalculationStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final PrimeNumberCalculationStatusTypeSupport _singleton
        = new PrimeNumberCalculationStatusTypeSupport();    
    ...
    public static PrimeNumberCalculationStatusTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static PrimeNumberCalculationStatusTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = PrimeNumberCalculationStatusTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public Class get_type() {
        return PrimeNumberCalculationStatus.class;
    }
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
PrimeNumberCalculationStatus typedSrc = (PrimeNumberCalculationStatus) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = PrimeNumberCalculationStatus.valueOf(ordinal);
    ...
    protected PrimeNumberCalculationStatusTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,PrimeNumberCalculationStatusTypeCode.VALUE,PrimeNumberCalculationStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
