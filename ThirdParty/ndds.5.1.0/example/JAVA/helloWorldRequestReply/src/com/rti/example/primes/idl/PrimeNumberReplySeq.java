...
/**
 * A sequence of PrimeNumberReply instances.
 */
public final class PrimeNumberReplySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public PrimeNumberReplySeq() {
        super(PrimeNumberReply.class);
    }


    public PrimeNumberReplySeq(int initialMaximum) {
        super(PrimeNumberReply.class, initialMaximum);
    }


    public PrimeNumberReplySeq(Collection elements) {
        super(PrimeNumberReply.class, elements);
    }
