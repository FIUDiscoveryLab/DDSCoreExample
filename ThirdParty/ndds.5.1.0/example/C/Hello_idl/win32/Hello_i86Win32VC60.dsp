...
SOURCE=..\src\idl\HelloWorldPlugin.c
# End Source File
# Begin Source File
...
SOURCE=..\src\idl\HelloWorldSupport.c
# End Source File
# Begin Source File
...
"../src/idl/HelloWorld.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"../src/idl/HelloWorldPlugin.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"../src/idl/HelloWorldPlugin.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"../src/idl/HelloWorldSupport.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"../src/idl/HelloWorldSupport.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
